...
public class Residente extends Persona{
    ...
    public Residente(String cedula, String nombre, String telefono, String email,String mz,String villa,Estado estado){
    ...
    public static void informacionResidentes(ArrayList<Residente> lista_Residentes){
        ...
        if(op==2){
            ...
            if(nTipo.equals("ACTIVO")){
                lista_Residentes.add(new Residente(nuevaCedula,nuevoNombre,nuevoTelefono,nuevoEmail,mz,villa,Estado.ACTIVO));
            }
            if(nTipo.equals("INACTIVO")){
            lista_Residentes.add(new Residente(nuevaCedula,nuevoNombre,nuevoTelefono,nuevoEmail,mz,villa,Estado.INACTIVO));
          }
        ...
        if(op==3){
         ...
         opcion.nextLine();
          ...
          Residente residente_modificado=null;
    ...
    public static void informacionResidentes(Residente r){
      Scanner opcion=new Scanner(System.in);
  ...
  public static void eliminarResidente(ArrayList<Residente> lista_Residentes,Residente residente){
      for(Residente r:lista_Residentes){
